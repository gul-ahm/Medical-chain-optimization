...
async def run_test():
    ...
    try:
        ...
        # -> Type a supply-chain question into input index 3011 and submit it by clicking the send button index 3012.
        ...
        await elem.wait_for(state="visible", timeout=10000)
        await elem.fill("Which warehouses are at highest risk of stockouts for critical medicines in the next 7 days, and what transfers are recommended?")
